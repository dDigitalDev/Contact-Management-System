    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800"><?php if (isset($_SESSION['message'])): ?>
	<div class="msg">
		<?php 
...
<?php endif ?>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Dashboard/Manage Contacts</h6>
            </div>
            
            <div class="card-body">
              <div class="table-responsive">
        <?php 
        //$db = $db = mysqli_connect("localhost", "root", "", "contacts_management_system");
        ...
        ?>
		      ...
		      <tr>
                ...
                <td>
				   <a href="edit.php?edit=<?php echo $row['id']; ?>" class="btn btn-primary btn-xs" >Edit</a> <br>
				   <a href="process.php?del=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
			    </td>
		     </tr>
	<?php } ?>
                </table>
