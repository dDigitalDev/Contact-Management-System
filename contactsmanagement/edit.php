        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Dashboard/Edit Contacts</h6>
            </div>
...
<input type="hidden" name="id" value="<?php echo $id; ?>">
  ...
  <div class="form-row">
    ...
    <!-- Default input -->
    <div class="form-group col-md-6">
      <input type="text" class="form-control" name="Profession" value="<?php echo $Profession; ?>"  placeholder="Profession">
    </div>
  </div>
  <!-- Grid row -->
  ...
  <div class="form-group">
    <select name="contact_type">
      <option <?php if ($contact_type == 1) { ?> selected <?php } ?> value="1">Public</option>
      <option <?php if ($contact_type == 2) { ?> selected <?php } ?> value="2">Business</option>
		  <option <?php if ($contact_type == 3) { ?> selected <?php } ?> value="3">Private</option>
	  </select> 
	</div>
...
<?php else: ?>
	<a href="allcontacts.php" class="btn btn-primary btn-xs">Edit</a>
<?php endif ?>
		</div>
</form>
<!-- Extended default form grid -->
